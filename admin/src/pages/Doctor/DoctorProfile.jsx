  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div>
          <img className='bg-[#5F6FFF]/80 w-full sm:max-w-64 rounded-lg ' src={profileData.image} alt="" srcset="" />
        </div>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {
            isEdit
              ? <button onClick={() => updateProfile()} className='px-4 py-1 bg-[#5F6FFF] text-white text-sm rounded-full mt-5 hover:bg-[#4e5bff] transition-all'>Save</button>
              :
